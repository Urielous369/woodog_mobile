...
class SuggestedWalkersInfoCard extends StatefulWidget {
  const SuggestedWalkersInfoCard({
    super.key,
    required this.image,
    required this.name,
  ...
  @override
  State<SuggestedWalkersInfoCard> createState() => _SuggestedWalkersInfoCardState();
}

class _SuggestedWalkersInfoCardState extends State<SuggestedWalkersInfoCard> {
  @override
