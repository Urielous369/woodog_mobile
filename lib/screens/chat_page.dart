      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            const CircleAvatar(
              backgroundImage:
                  AssetImage("assets/images/walker_3.jpeg"),
            ),
            ...
            Column(
              ...
              children: [
                Text(
                  "Alex Murray",
                  style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.bold, color: kBlackColor)
                  // TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: kBlackColor),
                ),
                Text(
                  "Active 3m ago",
                  style: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.normal, color: kBlackColor)
                )
              ],
            )
          ],
